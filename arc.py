...
class AdvancedCharacter(Character):
    ...
    def sus_update_conflict_and_goal_based_on_history(self, history, previous_goal, previous_conflict, arc, current_act, act_goal):
        """
    ...
    def sus_choose_action(self, event_description, event_characters, history, current_act, act_goals=None):
