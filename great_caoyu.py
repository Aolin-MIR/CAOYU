...
if __name__ == "__main__":
    ...
    if os.path.exists('great12.7.json'):
        scenes_generated = load_scenes_from_json('great12.7.json')
    else:
        scenes_generated = dynamic_scene_generation(input_data12,'复仇')
        save_scenes_to_json(scenes_generated, 'great12.7.json')
    scenes_generated = add_foreshadowing_and_clues_to_scene_list(scenes_generated,'复仇')
    ...
    # 保存生成的场景到 JSON 文件
    save_scenes_to_json(scenes_generated, 'great12.7add.json')